...
export default function Home(){
    ...
    <>
        ...
        <section>
            ...
            <article>
                <h2>Routing pages</h2>
                <p>To route a page you'll have to make the file/pages you want the website be able to navigate to. The image below is an example where there's been made a About, Contact and Home .jsx file. <br />
                ...
                <p>Index is used to tell react-router which page should be yout main page/the page your website starts on. <br />
            ...
            <article>
                ...
                <p>To be able to navigate between pages on your website you will need to make use of the Link component and/or useNavigate function. Both imported from "react-router" as seen in the example below. <br />
                They are used in the files/pages where you want the user be able to navigate to and from other pages</p>
            ...
            <article>
                ...
                <p>As seen in the image below, you make another Route component with element = the file you want and the path that = "*". <br />
                This means that every endpoint thats not = any endpoint you've already made should direct the user to the error page.</p>
